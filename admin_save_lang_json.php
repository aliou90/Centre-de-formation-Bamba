...
if (!$data || !isset($data['book']) || !isset($data['lang']) || !isset($data['trans']) || empty(trim($data['lang'])) || empty(trim($data['trans'])) ) {
...
// Mettre à jour uniquement lang et trans
$config['lang'] = $data['lang'];
$config['trans'] = $data['trans'];
